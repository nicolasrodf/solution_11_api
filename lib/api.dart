...
class Api {
  ...
  Future<List> getUnits(String category) async {
    final uri = Uri.https(_url, '/$category'); //el uri a devolver en category_route va a ser https://flutter.udacity.com/currency el cual contiene el json con todos los units
  ...
  /// ****Se usa en el unit_converter para hacer la conversion con api
  ...
  Future<double> convert(
    ...
    return jsonResponse['conversion'].toDouble(); //jsonResponse should be status = ok and conversion = el resultado
    //test: https://flutter.udacity.com/currency/convert?from=US%20Dollar&to=Gold%20Bar&amount=500.0
  }

  //GET JSON RESPONSE METHOD
